...
def create_vector_store(documents: List[Document], api_key: str):
    ...
    class EnhancedVectorStore:
        ...
        def similarity_search(self, query, k=15):  # Much more results for better understanding
            ...
            # Return documents with scores - much lower threshold for better understanding
            results = []
            for i, (score, idx) in enumerate(zip(D[0], I[0])):
                if idx < len(self.documents) and score > 0.005:  # Much lower threshold
                    results.append(self.documents[idx])
            
            # Return top 8 most relevant for better context
            return results[:8]
        ...
        def _expand_query(self, query):
            ...
            expansions = {
                'what': 'information details content',
                ...
                'details': 'information specifics facts',
                'topic': 'subject matter theme',
                'main': 'primary key important',
                'important': 'key main significant',
                'explain': 'describe clarify explain',
                'tell': 'describe explain inform',
...
def get_qa_chain(vector_store, api_key: str):
    ...
    llm = ChatGroq(
        ...
        model_name="mixtral-8x7b-32768",  # Better model for understanding queries
...
2. Look for relevant information in the documents that matches their question
...
6. Quote relevant text from the documents when helpful
7. If multiple documents contain relevant information, combine them clearly
8. Always be clear about what information you found and what you didn't find
